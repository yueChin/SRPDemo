...
namespace CustomRP.Runtime
{
    public partial class Shadows
    {
        ...
        private void RenderDirectionalShadows()
        {
            ...
            m_Buffer.GetTemporaryRT(s_DireShadowAtlasId,atlasSize,atlasSize,32,FilterMode.Bilinear,RenderTextureFormat.Shadowmap);
            m_Buffer.SetRenderTarget(s_DireShadowAtlasId,RenderBufferLoadAction.DontCare,RenderBufferStoreAction.Store);
            m_Buffer.ClearRenderTarget(true,false,Color.clear);
            m_Buffer.SetGlobalFloat(s_ShadowPanckingId,1f);
